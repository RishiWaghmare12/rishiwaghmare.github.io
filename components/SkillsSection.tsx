...
const skillIcons: Record<string, React.ReactNode> = {
  ...
  JavaScript: <FaJsSquare className="w-6 h-6" />,
  TypeScript: <SiTypescript className="w-6 h-6" />,
  'React.js': <FaReact className="w-6 h-6" />,
  'Node.js': <FaNode className="w-6 h-6" />,
  ...
  Qiskit: <SiQiskit className="w-6 h-6" />,
  Git: <FaGit className="w-6 h-6" />,
  Linux: <FaLinux className="w-6 h-6" />,
  'REST APIs': <FaDatabase className="w-6 h-6" />,
  'YOLOv8': <FaBrain className="w-6 h-6" />,
};
                      ...
                      <div className="flex flex-col items-center justify-center gap-3 h-full">
                        <div className="text-muted group-hover:text-accent group-hover:scale-110 transition-all duration-300">
                          {skillIcons[skill.name] || (
                            <div className="w-6 h-6 bg-accent/10 rounded-md border border-accent/20" />
                          )}
                        </div>
                        <p className="text-sm font-medium text-text text-center group-hover:text-accent smooth-transition">
                          {skill.name}
                        </p>
                      </div>
                    </motion.div>
